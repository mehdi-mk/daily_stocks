...
# --- Configuration ---
PYTHON_SCRIPT_PATH="/Users/mehdik/stock_data_FMP_API.py" # Absolute path to your Python script
SQL_SCRIPT_DAILY_DATA="/Users/mehdik/LOAD_fm_daily_stock_data.sql" # Absolute path
SQL_SCRIPT_PROFILES="/Users/mehdik/LOAD_company_profiles.sql"   # Absolute path

# IMPORTANT NOTE: Set the correct username and database name here
...
# IMPORTANT NOTE: Set the correct path for your Python
...
# IMPORTANT NOTE: Set the correct path for your PSQL
